            ...
            <>
              <div className="flex flex-wrap justify-between w-full mb-2">
                ...
                <Disclosure.Button
                  ...
                  className=" justify-items-end px-2 py-1 ml-auto text-gray-500 rounded-md lg:hidden hover:text-indigo-500 focus:text-indigo-500 focus:bg-indigo-100 focus:outline-none dark:text-gray-300 dark:focus:bg-trueGray-700 hidden md:block"
                >
                  <svg
