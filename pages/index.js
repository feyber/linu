  ...
  return (
    <>
      <div div className="w-11/12 mx-auto">
        ...
        <Hero />
        <Testimonials />
        <SectionTitle pretitle="" title="R  O  A  D  M  A  P"></SectionTitle>
        ...
        <Container>
          <div className="flex flex-col justify-center w-full mt-20 lg:mt-20">
            <Tilt tiltReverse={true} tiltAxis={"y"}>
              <div
                id="service"
                className="flex flex-col sm:flex-row sm:w-full items-center justify-around space-x-4 -mt-10 js-show-on-scroll drop-shadow-md"
              >
                <div className="flex flex-col bg-indigo-50 items-center justify-center w-full h-full lg:w-4/12 lg:h-50 p-4 shadow-md blur-3 rounded-lg bg-opacity-25 ml-4 mb-4 hover:shadow-xl lg:hover:-translate-y-12 scale-90 hover:scale-100 md:scale-100 duration-700">
